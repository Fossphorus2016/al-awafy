...
Route::prefix('en')->group(function () {
    Route::get('/about', function () {return view('en.about');})->name('en.about');
    Route::get('/home', function () {return view('en.home');})->name('en.home');
    Route::get('/contact', function () {return view('en.contact_us');})->name('en.contact');
...
Route::prefix('ar')->group(function () {
    Route::get('/about', function () {return view('ar.about');})->name('ar.about');
    Route::get('/home', function () {return view('ar.home');})->name('ar.home');
    Route::get('/contact', function () {return view('ar.contact_us');})->name('ar.contact');
...
Route::prefix('fr')->group(function () {
    Route::get('/about', function () {return view('fr.about');})->name('fr.about');
    Route::get('/home', function () {return view('fr.home');})->name('fr.home');
    Route::get('/contact', function () {return view('fr.contact_us');})->name('fr.contact');

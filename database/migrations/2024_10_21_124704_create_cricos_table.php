...
return new class extends Migration
{
    ...
    {
        Schema::create('cricos', function (Blueprint $table) {
            $table->id();
            ...
            $table->longText('brand_2_p')->nullable();
            ...
            $table->longText('brand_3_p')->nullable();
            ...
            $table->longText('brand_4_p')->nullable();

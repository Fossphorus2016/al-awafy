...
class AdminHomeController extends Controller
{
    ...
    public function french_admin_home()
    {
        $home_french = Home::where('language', 'french')->first();
    ...
    public function french_meta_section(Request $request)
    {
        // Validate the request inputs
        $request->validate([
            'meta_title' => 'required',
        ...
        // Find the first home record with the french language
        $home = Home::where('language', 'french')->first();
        ...
        if ($home) {
            ...
            // Create a new record if none exists with French language
            Home::create([
                'language' => 'french',  // This is the key change here
                'meta_title' => $request->input('meta_title'),
                'meta_description' => $request->input('meta_description'),
                'canonical' => $request->input('canonical'),
            ]);

            return back()->with('message', 'Meta data created successfully.');
        }
    }



    public function french_admin_home_banner_1(Request $request)
    {
        // Validate the request inputs
        $request->validate([
    ...
    public function french_admin_home_banner_2(Request $request)
    {
        // Validate the request inputs
        $request->validate([
    ...
    public function french_admin_home_banner_3(Request $request)
    {
        // Validate the request inputs
        $request->validate([
    ...
    public function french_admin_home_about(Request $request)
    {
    ...
    public function french_admin_home_our_value(Request $request)
    {
        // Validate the request inputs
        $request->validate([
            'our_value_1' => 'required',
    ...
    public function french_admin_home_section_6(Request $request)
    {
        $request->validate([
            'section_6_h1' => 'required',
            'section_6_h2' => 'required',
    ...
    public function french_admin_home_our_brand_1(Request $request)
    {
        $request->validate([
            'our_brand_1' => 'required',
    ...
    public function french_admin_home_our_brand_2(Request $request)
    {
        $request->validate([
            'our_brand_2' => 'required',
    ...
    public function french_admin_home_our_brand_3(Request $request)
    {
        $request->validate([
            'our_brand_3' => 'required',

...
<body>
    <div id="app">
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm {{ Route::is('login') ? 'd-none' : '' }}">
            <div class="container">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.card-sersec-cont').each(function() {
                $(this).find('*').each(function() {

        ...
        <section class="heroSection secondBanner contactBanner position-relative z-1">
            <div class="customContainer">
                <div class="heroSliderOuter">
                    ...
                    <div class="heroInner">
                        <h1 class="waterDropsBefore waterDropsAfter"> <span class="fs2"> سياسة </span>
                            <span class="fs3">الخصوصية</span>
                        </h1>
                    ...
                    <div class=" ">
                        ...
                        <ol class="listStyle2">
                            <li class="my-4">
                                ...
                                <ul class="arabicStyle listStyles">
                            ...
                            <li class="my-4">
                                ...
                                <ul class="listStyles arabicStyle inlineContent">
                                    <li >

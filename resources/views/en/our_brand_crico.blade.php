...
@endphp
<x-layout pageTitle="{{ isset($crico->meta_title) ? $crico->meta_title : '' }}" metaDescription="{{ isset($crico->meta_description) ? $crico->meta_description : '' }}" canonical="{{ isset($crico->canonical) ? $crico->canonical : '' }}">

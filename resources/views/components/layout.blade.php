                        ...
                        <ul class="navbar-nav justify-content-end ">
                            ...
                            <li class="nav-item ">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><div class="dropdown-item languages" href="#">English</div></li>
                                        <li><div class="dropdown-item languages" href="#">French</div></li>
                                        <li><div class="dropdown-item languages" href="#">Arabic</div></li>
                                    </ul>
                                </div>
                            </li>
                            <li class="nav-item ">
            ...
            <div class=" customContainer">
                <div class="row py-3 justify-content-center align-items-center">
                    ...
                    <div class="col-lg-6 col-12 privacyPages">
                        <a href="privacy_policy" class="text-white anchorHover">Privacy Policy</a> | <a
                            class="text-white anchorHover" href="terms_condition">Terms & Conditions</a>
                    </div>

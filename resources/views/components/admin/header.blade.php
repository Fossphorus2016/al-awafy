<div id="kt_header" style="" class="header align-items-stretch">
    ...
    <div class="header-brand">
        ...
        <a href="{{route('contact')}}">
            <img alt="Logo" src="{{asset('assets/logo/logo.png')}}" class="w-100 h-50px">
        </a>
    ...
    <div class="toolbar d-flex align-items-stretch">
        ...
        {{-- <div class="logOut mt-4 me-5">
            <a class="btn btn-outline-danger d-flex gap-3 align-items-center" href="/" onclick="event.preventDefault();
                            document.getElementById('logout-form').submit();">
                Logout <i class="text-danger fa-solid fa-right-from-bracket"></i>
            </a>

            <form id="logout-form" action="/" method="POST" class="d-none">
                <input type="hidden" name="_token" value="dW5iaD8ZRhrjBA1FSCl8q7Ls1wiHrVqLRACVSMxw" autocomplete="off">            </form>
        </div> --}}

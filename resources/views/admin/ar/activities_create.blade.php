    ...
    <div class="container arabicPage">
        <div class="row justify-content-center my-5 card shadow px-10 py-5">
            <div class="card-header px-0 align-content-center mb-5">
                <h2 class="fs-1 card-title primaryClr fw-bolder">إنشاء نشاط</h2>
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 mb-3">
                                                ...
                                                <label for="error_heading_1" id="error_heading_1"
                                                    class="text-danger fw-bold" style="display: none">العنوان مطلوب</label>
                                            </div>
                                            ...
                                            <div class="col-lg-12 mb-3">
                                                <label for="content" class="form-label">فقرة</label>
                                                ...
                                                <label for="error_paragraph" id="error_paragraph"
                                                    class="text-danger fw-bold" style="display: none">الفقرة مطلوبة</label>
                                            </div>
                                ...
                                <div class="text-center">
                                    <button type="button" onclick="blog_validate()"
                                        class="btn btn-primary">يخلق</button>
                                </div>
                    </form>
                </div>
            </div>

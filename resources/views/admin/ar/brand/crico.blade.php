<x-admin.layouts title="Crico | Arabic">
            ...
            <div class="accordion" id="accordionExample">
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseZero" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <form action="{{ route('crico.meta') }}" method="POST" class="mt-5 formValidation">
                                @csrf
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseZero2" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <div>
                                <form action="{{ route('crico.banner') }}" method="POST" enctype="multipart/form-data"
                                    ...
                                    <div class="row gy-4">
                                        <div class="col-6">
                                            <div>
                                                <label for="banner_h1">العنوان 1</label>
                                        ...
                                        <div class="col-6">
                                            <div>
                                                <label for="banner_h2">العنوان 2</label>
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            ...
                            <div class="">
                                ...
                                <form action="{{ route('crico.section.2') }}" method="POST"
                                    ...
                                    <div class="row gy-4">
                                        <div class="col-6">
                                            ...
                                            <div class="editorOut91">
                                                <label for="section1_h1">العنوان 1</label>
                                ...
                                <div class="accordion" id="accordionBrand">
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapse11" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body">
                                                <form action="{{ route('crico.item.1') }}" method="POST"
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapse12" class="accordion-collapse collapse"
                                            data-bs-parent="#accordionBrand">
                                            <div class="accordion-body">
                                                <form action="{{ route('crico.item.2') }}" method="POST"
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapse13" class="accordion-collapse collapse"
                                            data-bs-parent="#accordionBrand">
                                            <div class="accordion-body">
                                                <form action="{{ route('crico.item.3') }}" method="POST"
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapse14" class="accordion-collapse collapse"
                                            data-bs-parent="#accordionBrand">
                                            <div class="accordion-body">
                                                <form action="{{ route('crico.item.4') }}" method="POST"
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapse15" class="accordion-collapse collapse"
                                            data-bs-parent="#accordionBrand">
                                            <div class="accordion-body">
                                                <form action="{{ route('crico.item.5') }}" method="POST"
    ...
    <script>
        $(document).ready(function() {
            ...
            const brand_6_p = Jodit.make('#brand_6_p' , joditConfig);
            ...
            $('.formValidation6').submit(function(event) {
                ...
                if (!brand_3_p.value.trim() || brand_3_p.value.trim() === '<p><br></p>') {
                    ...
                    $('.editorOut14 .errMsg').text('فقرة is required.');
                    valid = false;
                }
            ...
            $('.formValidation7').submit(function(event) {
                ...
                if (!brand_4_p.value.trim() || brand_4_p.value.trim() === '<p><br></p>') {
                    ...
                    $('.editorOut18 .errMsg').text('فقرة is required.');
                    valid = false;
                }
            ...
            $('.formValidation8').submit(function(event) {
                ...
                if (!brand_5_p.value.trim() || brand_5_p.value.trim() === '<p><br></p>') {
                    ...
                    $('.editorOut22 .errMsg').text('فقرة is required.');
                    valid = false;
                }
            ...
            $('.formValidation9').submit(function(event) {
                ...
                if ($(".editorOut24 input").val() == "") {
                    ...
                    $(".editorOut24 .errMsg").text('عنوان is required');
                    valid = false
                } else {
                ...
                if ($(".editorOut25 input").val() == "") {
                    ...
                    $(".editorOut25 .errMsg").text('عنوان is required');
                    valid = false
                } else {
                ...
                if (!brand_6_p.value.trim() || brand_6_p.value.trim() === '<p><br></p>') {
                    ...
                    $('.editorOut26 .errMsg').text('فقرة is required.');
                    valid = false;
                }

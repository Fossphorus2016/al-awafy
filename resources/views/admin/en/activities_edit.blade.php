<x-admin.layouts title=" Edit Event News">
    ...
    <div class="container">
        <div class="row justify-content-center my-5 card shadow px-10 py-5">
            ...
            <div class="col-md-12">
                <div class="card-body">
                    <form action="{{ route('event.news.update') }}" id="events_news_form" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        {{-- <div id="existing-images">
                                            @if ($events_news->images)
                                                @php
                                                    $decodedImages = json_decode($events_news->images);
                                                @endphp
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="image_alt" id="image_alt" class="form-control"
                                                value="{{ old('image_alt', $events_news->image_alt) }}">
                                            <label for="" id="error_main_image_alt" class="text-danger fw-bold"
                                                style="display: none">Image alt is
                                                required</label>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    function event_news_validate() {
        if ($("#meta_title").val() == "") {
            ...
            $("#meta_title").removeClass("is-invalid");

<x-admin.layouts title="About | English">
    <div class="card">
        <div class="card-body">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div>
                                            ...
                                            <input class="form-control" name="meta_title"
                                                value="{{ old('meta_title', $about_english->meta_title ?? '') }}"></input>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div>
                                            ...
                                            <input class="form-control" name="meta_description"
                                                value="{{ old('meta_description', $about_english->meta_description ?? '') }}"></input>
                                            <p class="errMsg text-danger"></p>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div>
                                            ...
                                            <input class="form-control" name="canonical"
                                                value="{{ old('canonical', $about_english->canonical ?? '') }}"></input>
                                            <p class="errMsg text-danger"></p>
                                        </div>
                                    </div>
                            ...
                            <div>
                                <form action="{{ route('about.section.1') }}" method="POST"
                                    ...
                                    <div class="row gy-4">
                                        <div class="col-6">
                                            ...
                                            <div class="editorOut12">
                                                ...
                                                <input class="form-control" name="sec1_h1"
                                                    value="{{ old('sec1_h1', $about_english->sec1_h1 ?? '') }}"></input>
                                                <p class="errMsg text-danger"></p>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            ...
                                            <div class="class="editorOut13>
                                                ...
                                                <input class="form-control" name="sec1_h2"
                                                    value="{{ old('sec1_h2', $about_english->sec1_h2 ?? '') }}"></input>
                                                <p class="errMsg text-danger"></p>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                        ...
                                        <div class="col-12">
                                            @if ($about_english && $about_english->sec1_image)
                                                <img src="{{ asset('storage/' . $about_english->sec1_image) }}"
                            ...
                            <div class="">
                                ...
                                <form action="{{ route('about.section.2') }}" method="POST"
                                    ...
                                    <div class="row gy-4">
                                        <div class="col-6">
                                            ...
                                            <div class="editorOut10">
                                                ...
                                                <input class="form-control" name="sec2_h1"
                                                    value="{{ old('sec2_h1', $about_english->sec2_h1 ?? '') }}"></input>
                                                <p class="errMsg text-danger"></p>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            ...
                                            <div class="editorOut11">
                                                ...
                                                <input class="form-control" name="sec2_h2"
                                                    value="{{ old('sec2_h2', $about_english->sec2_h2 ?? '') }}"></input>
                                                <p class="errMsg text-danger"></p>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            ...
                                            <div class="editorOut1">
                                                ...
                                                <textarea id="editor1" class="editor1" name="sec2_p1" value="">{{ old('sec2_p1', $about_english->sec2_p1 ?? '') }}</textarea>
                                                <p class="errMsg text-danger"></p>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            ...
                                            <div class="editorOut2">
                                                ...
                                                <textarea id="editor2" class="editor2 " name="sec2_p2" value="">{{ old('sec2_p2', $about_english->sec2_p2 ?? '') }}</textarea>
                                                <p class="errMsg text-danger"></p>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            @if ($about_english && $about_english->sec2_image)
                                                <img src="{{ asset('storage/' . $about_english->sec2_image) }}"
                                                    alt="" id="imgU11"
                                                    style="background-color:lightgrey; max-width: 1600px; width: 100%; height: 460px; object-fit: contain;">
                                            @else
                                                upload an image
                                    ...
                                    <div class="row gy-4">
                                        <div class="col-12">
                                            <div class="editorOut4">
                                                ...
                                                <input type="text" class="form-control" name="sec3_h1"
                                                    value="{{ old('sec3_h1', $about_english->sec3_h1 ?? '') }}">
                                                <p class="errMsg text-danger"></p>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="editorOut5">
                                                ...
                                                <input type="text" class="form-control" name="sec3_h2"
                                                    value="{{ old('sec3_h2', $about_english->sec3_h2 ?? '') }}">
                                                <p class="errMsg text-danger"></p>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="editorOut6">
                                                <label for="">Paragraph 1</label>
                                                <textarea class="editor4" name="sec3_p1" value="">{{ old('sec3_p1', $about_english->sec3_p1 ?? '') }}</textarea>
                                                <p class="errMsg text-danger"></p>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="editorOut8">
                                                ...
                                                <input type="text" class="form-control" name="sec3_h3"
                                                    value="{{ old('sec3_h3', $about_english->sec3_h3 ?? '') }}">
                                                <p class="errMsg text-danger"></p>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="editorOut9">
                                                ...
                                                <input type="text" class="form-control" name="sec3_h4"
                                                    value="{{ old('sec3_h4', $about_english->sec3_h4 ?? '') }}">
                                                <p class="errMsg text-danger"></p>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="editorOut7">
                                                <label for="">Paragraph 1</label>
                                                <textarea class="editor5" name="sec3_p2" value="">{{ old('sec3_p2', $about_english->sec3_p2 ?? '') }}</textarea>
                                                <p class="errMsg text-danger"></p>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            @if ($about_english && $about_english->sec3_image)
                                                <img src="{{asset('storage/'.$about_english->sec3_image)}}" alt="" id="imgU12"
                                                    style="background-color:lightgrey; max-width: 1600px; width: 100%; height: 460px; object-fit: contain;">
                                            @else
                                            upload an image
                                            @endif

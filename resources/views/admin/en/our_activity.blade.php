                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseZero" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <form action="" method="POST" class="mt-5 formValidation">
                                @csrf
                            ...
                            <div>
                                <form action="" method="POST"
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-12">
                                            <img  alt="" id="uploadedImage1" style="background-color:lightgrey; max-width: 1600px; width: 100%; height: 460px; object-fit: contain; ">
                                        </div>
                                        <div class="col-12">
                                            <button type="submit" class="btn btn-primary">Save</button>
                                        </div>

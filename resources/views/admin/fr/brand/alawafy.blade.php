                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-12">
                                            @if ($brand_alawafy && $brand_alawafy->section1_image)
                                                <img src="{{asset('storage/'.$brand_alawafy->section1_image)}}" alt="" id="upload_section1_image"
                                                ...
                                                <form action="{{route('alawafy.item.1')}}" method="POST" enctype="multipart/form-data" class="mt-5 formValidation2">
                                                    ...
                                                    <div class="row gy-4">
                                                        ...
                                                        <div class="col-6">
                                                            <div>
                                                                <label for="banner_1_image">Banner Image</label>
                                                                <input type="file" class="form-control " name="brand_1_image" id="brand_1_image" >
                                                        ...
                                                        <div class="col-12">
                                                            @if ($brand_alawafy && $brand_alawafy->brand_1_image)
                                                                <img src="{{asset('storage/'.$brand_alawafy->brand_1_image)}}" id="upload_brand_1_image" alt=""
                                                                    style="background-color:lightgrey; max-width: 1140px; width: 100%; height: 450px; object-fit: contain;">
                                                            @endif
                                                ...
                                                <form action="{{route('alawafy.item.2')}}" method="POST" enctype="multipart/form-data" class="mt-5 formValidation2">
                                                    ...
                                                    <div class="row gy-4">
                                                        ...
                                                        <div class="col-6">
                                                            <div>
                                                                <label for="banner_1_image">Banner Image</label>
                                                                <input type="file" class="form-control " name="brand_2_image" id="brand_2_image" >
                                                        ...
                                                        <div class="col-12">
                                                            @if ($brand_alawafy && $brand_alawafy->brand_2_image)
                                                                <img src="{{asset('storage/'.$brand_alawafy->brand_2_image)}}" alt=""
                                                                  id="upload_brand_2_image"  style="background-color:lightgrey; max-width: 1140px; width: 100%; height: 450px; object-fit: contain;">
                                                            @endif
                                                ...
                                                <form action="{{route('alawafy.item.3')}}" method="POST" enctype="multipart/form-data" class="mt-5 formValidation2">
                                                    ...
                                                    <div class="row gy-4">
                                                        ...
                                                        <div class="col-6">
                                                            <div>
                                                                <label for="banner_1_image">Banner Image</label>
                                                                <input type="file" class="form-control " name="brand_3_image" id="brand_3_image" >
                                                        ...
                                                        <div class="col-12">
                                                            @if ($brand_alawafy && $brand_alawafy->brand_3_image)
                                                                ...
                                                                id="upload_brand_3_image" style="background-color:lightgrey; max-width: 1140px; width: 100%; height: 450px; object-fit: contain;">
                                                            @endif
                                                ...
                                                <form action="{{route('alawafy.item.4')}}" method="POST" enctype="multipart/form-data" class="mt-5 formValidation2">
                                                    ...
                                                    <div class="row gy-4">
                                                        ...
                                                        <div class="col-6">
                                                            <div>
                                                                <label for="banner_1_image">Banner Image</label>
                                                                <input type="file" class="form-control " name="brand_4_image" id="brand_4_image" >
                                                        ...
                                                        <div class="col-12">
                                                            @if ($brand_alawafy && $brand_alawafy->brand_4_image)
                                                                <img src="{{asset('storage/'.$brand_alawafy->brand_4_image)}}" alt=""
                                                                 id="upload_brand_4_image"   style="background-color:lightgrey; max-width: 1140px; width: 100%; height: 450px; object-fit: contain;">
                                                            @endif
                                                ...
                                                <form action="{{route('alawafy.item.5')}}" method="POST" enctype="multipart/form-data" class="mt-5 formValidation2">
                                                    ...
                                                    <div class="row gy-4">
                                                        ...
                                                        <div class="col-6">
                                                            <div>
                                                                <label for="banner_1_image">Banner Image</label>
                                                                <input type="file" class="form-control " name="brand_5_image" id="brand_5_image">
                                                        ...
                                                        <div class="col-12">
                                                            @if ($brand_alawafy && $brand_alawafy->brand_5_image)
                                                                <img src="{{asset('storage/'.$brand_alawafy->brand_5_image)}}" alt=""
                                                                 id="upload_brand_5_image"   style="background-color:lightgrey; max-width: 1140px; width: 100%; height: 450px; object-fit: contain;">
                                                            @endif
                                                ...
                                                <form action="{{route('alawafy.item.6')}}" method="POST" enctype="multipart/form-data" class="mt-5 formValidation2">
                                                    ...
                                                    <div class="row gy-4">
                                                        ...
                                                        <div class="col-6">
                                                            <div>
                                                                <label for="banner_1_image">Banner Image</label>
                                                                <input type="file" class="form-control " name="brand_6_image" id="brand_6_image">
                                                        ...
                                                        <div class="col-12">
                                                            @if ($brand_alawafy && $brand_alawafy->brand_6_image)
                                                                ...
                                                                id="upload_brand_6_image"    style="background-color:lightgrey; max-width: 1140px; width: 100%; height: 450px; object-fit: contain;">
                                                            @endif
                                                ...
                                                <form action="{{route('alawafy.item.7')}}" method="POST" enctype="multipart/form-data" class="mt-5 formValidation2">
                                                    ...
                                                    <div class="row gy-4">
                                                        ...
                                                        <div class="col-6">
                                                            <div>
                                                                <label for="banner_1_image">Banner Image</label>
                                                                <input type="file" class="form-control " name="brand_7_image" id="brand_7_image" >
                                                        ...
                                                        <div class="col-12">
                                                            @if ($brand_alawafy && $brand_alawafy->brand_7_image)
                                                                <img src="{{asset('storage/'.$brand_alawafy->brand_7_image)}}" id="upload_brand_7_image" alt=""
                                                                    style="background-color:lightgrey; max-width: 1140px; width: 100%; height: 450px; object-fit: contain;">
                                                            @endif

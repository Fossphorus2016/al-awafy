                                        ...
                                        <div class="col-12">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" name="banner_1_p1"
                                                    value="{{ old('banner_1_p1', $home_french->banner_1_p1 ?? '') }}">
                                                @error('banner_1_p')
                                                    <p class="errMsg text-danger">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" name="banner_1_p2"
                                                    value="{{ old('banner_1_p2', $home_french->banner_1_p2 ?? '') }}">
                                                @error('banner_1_p')
                                                    <p class="errMsg text-danger">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" class="form-control" name="banner_2_p1"
                                                    value="{{ old('banner_2_p1', $home_french->banner_2_p1 ?? '') }}">
                                                <p class="errMsg text-danger"></p>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" class="form-control" name="banner_2_p2"
                                                    value="{{ old('banner_2_p2', $home_french->banner_2_p2 ?? '') }}">
                                                <p class="errMsg text-danger"></p>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" class="form-control" name="banner_3_p1"
                                                    value="{{ old('banner_3_p1', $home_french->banner_3_p1 ?? '') }}">
                                                <p class="errMsg text-danger"></p>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" class="form-control" name="banner_3_p2"
                                                    value="{{ old('banner_3_p2', $home_french->banner_3_p2 ?? '') }}">
                                                <p class="errMsg text-danger"></p>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div>
                                            ...
                                            <input class="form-control" name="our_value_h1"
                                                value="{{ old('our_value_h1', $home_french->our_value_h1 ?? '') }}"></input>
                                            <p class="errMsg text-danger"></p>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        ...
                                        <div>
                                            ...
                                            <input class="form-control" name="our_value_h2"
                                                value="{{ old('our_value_h2', $home_french->our_value_h2 ?? '') }}"></input>
                                            <p class="errMsg text-danger"></p>
                                        </div>
                                    </div>
                                    <div class="col-6">
